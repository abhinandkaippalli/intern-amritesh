      ...
      <div className={styles.part3}>
        <div>
          ...
          <div className={styles.movies}>
            <Link to="/movies/roohi/ET00099813" className={styles.link}>
              Roohi
            </Link>
            <div className={styles.line}></div>
            <Link
              to="/movies/roberrt-telugu/ET00307859"
            ...
            <div className={styles.line}></div>
            <Link
              to="/movies/srikaaram-sreekaram/ET00106100"
              className={styles.link}
            >
              Srikaaram (Sreekaram)
            </Link>
            <div className={styles.line}></div>
            <Link to="/movies/jathi-ratnalu/ET00305719" className={styles.link}>
              Jathi Ratnalu
            </Link>
            <div className={styles.line}></div>
            <Link
            ...
            <div className={styles.line}></div>
            <Link to="/movies/gaali-sampath/ET00307385" className={styles.link}>
              Gaali Sampath
            </Link>
            <div className={styles.line}></div>
            <Link to="/movies/hero/ET00306303" className={styles.link}>
              Hero
            </Link>
            <div className={styles.line}></div>
            <Link to="/movies/a1-express/ET00113853" className={styles.link}>
              A1 Express
            </Link>
            <div className={styles.line}></div>
            <Link
              to="/movies/tom-jerry-tamil/ET00304828"
              className={styles.link}
            >
              Tom &amp; Jerry
            </Link>
        ...
        <div>
          ...
          <div className={styles.movies}>
            <Link to="/movies/tsunami/ET00307578" className={styles.link}>
              Tsunami
            </Link>
            <div className={styles.line}></div>
            <Link
            ...
            <div className={styles.line}></div>
            <Link to="/movies/romiyo-whisky/ET00307958" className={styles.link}>
              Romiyo Whisky
            </Link>
            <div className={styles.line}></div>
            <Link to="/movies/puaada/ET00099872" className={styles.link}>
              Puaada
            </Link>
            <div className={styles.line}></div>
            <Link to="/movies/gaali-sampath/ET00307385" className={styles.link}>
            ...
            <div className={styles.line}></div>
            <Link to="/movies/tandav/ET00308037" className={styles.link}>
              Tandav
            </Link>
            <div className={styles.line}></div>
            <Link to="/movies/aarkkariyam/ET00307366" className={styles.link}>
              Aarkkariyam
            </Link>
            <div className={styles.line}></div>
            <Link to="/movies/the-priest/ET00305064" className={styles.link}>
              The Priest
            </Link>
            <div className={styles.line}></div>
            <Link
            ...
            <div className={styles.line}></div>
            <Link to="/movies/roberrt/ET00121878" className={styles.link}>
              Roberrt
            </Link>
            <div className={styles.line}></div>
            <Link to="/movies/koli-taal/ET00132563" className={styles.link}>
              Koli Taal
            </Link>
            <div className={styles.line}></div>
            <Link
              to="/movies/theethum-nandrum/ET00308033"
              className={styles.link}
            >
              Theethum Nandrum
            </Link>
            <div className={styles.line}></div>
            <Link to="/movies/time-to-dance/ET00078875" className={styles.link}>
              Time To Dance
            </Link>
            <div className={styles.line}></div>
            <Link
              to="/movies/love-life-and-pakodi/ET00136443"
              className={styles.link}
            >
              Love Life And Pakodi
            </Link>
            <div className={styles.line}></div>
            <Link to="/movies/ganesapuram/ET00306595" className={styles.link}>
              Ganesapuram
            </Link>
            <div className={styles.line}></div>
            <Link to="/movies/varthamanam/ET00132941" className={styles.link}>
              Varthamanam
            </Link>
            <div className={styles.line}></div>
            <Link
            ...
            <div className={styles.line}></div>
            <Link
              to="/movies/kaathal-ithu-kaathal/ET00308060"
              className={styles.link}
            >
        ...
        <div>
          <div>Upcomimg Movies</div>
          <div className={styles.movies}>
            <Link to="/explore/action-movies" className={styles.link}>
              Action Movies
            </Link>
            <div className={styles.line}></div>
            <Link to="/explore/drama-movies" className={styles.link}>
              Drama Movies
            </Link>
            <div className={styles.line}></div>
            <Link to="/explore/thriller-movies" className={styles.link}>
              Thriller Movies
            </Link>
            <div className={styles.line}></div>
            <Link to="/explore/comedy-movies" className={styles.link}>
              Comedy Movies
            </Link>
            <div className={styles.line}></div>
            <Link to="/explore/romantic-movies" className={styles.link}>
              Romantic Movies
            </Link>
            <div className={styles.line}></div>
            <Link to="/explore/adventure-movies" className={styles.link}>
              Adventure Movies
            </Link>
            <div className={styles.line}></div>
            <Link to="/explore/horror-movies" className={styles.link}>
              Horror Movies
            </Link>
            <div className={styles.line}></div>
            <Link to="/explore/fantasy-movies" className={styles.link}>
              Fantasy Movies
            </Link>
            <div className={styles.line}></div>
            <Link to="/explore/animation-movies" className={styles.link}>
              Animation Movies
            </Link>
            <div className={styles.line}></div>
            <Link to="/explore/crime-movies" className={styles.link}>
              Crime Movies
            </Link>
            <div className={styles.line}></div>
            <Link to="/explore/biography-movies" className={styles.link}>
              Biography Movies
            </Link>
            <div className={styles.line}></div>
            <Link to="/explore/musical-movies" className={styles.link}>
              Musical Movies
            </Link>
            <div className={styles.line}></div>
            <Link to="/explore/sci-fi-movies" className={styles.link}>
              Sci-Fi Movies
            </Link>
            <div className={styles.line}></div>
            <Link to="/explore/mystery-movies" className={styles.link}>
              Mystery Movies
            </Link>
            <div className={styles.line}></div>
            <Link to="/explore/suspense-movies" className={styles.link}>
              Suspense Movies
            </Link>
            <div className={styles.line}></div>
            <Link to="/explore/period-movies" className={styles.link}>
              Period Movies
            </Link>
            <div className={styles.line}></div>
            <Link to="/explore/Screening-movies" className={styles.link}>
              screening Movies
            </Link>
            <div className={styles.line}></div>
            <Link to="/explore/war-movies" className={styles.link}>
              War Movies
            </Link>
            <div className={styles.line}></div>
            <Link to="/explore/supernatural-movies" className={styles.link}>
              Supernatural Movies
            </Link>
            <div className={styles.line}></div>
            <Link to="/explore/adult-movies" className={styles.link}>
              Adult Movies
            </Link>
            <div className={styles.line}></div>
            <Link to="/explore/historical-movies" className={styles.link}>
              Historical Movies
            </Link>
            <div className={styles.line}></div>
            <Link to="/explore/psychological-movies" className={styles.link}>
              Psychological Movies
            </Link>
            <div className={styles.line}></div>
            <Link to="/explore/noir-movies" className={styles.link}>
              Noir Movies
            </Link>
            <div className={styles.line}></div>
            <Link to="/explore/political-movies" className={styles.link}>
              Political Movies
            </Link>
            <div className={styles.line}></div>
            <Link to="/explore/tragedy-movies" className={styles.link}>
              Tragedy Movies
            </Link>
            <div className={styles.line}></div>
            <Link to="/explore/mythological-movies" className={styles.link}>
              Mythological Movies
            </Link>
            <div className={styles.line}></div>
            <Link to="/explore/devotional-movies" className={styles.link}>
              Devotional Movies
            </Link>
            <div className={styles.line}></div>
            <Link to="/explore/bollywood-movies" className={styles.link}>
              Bollywood Movies
            </Link>
            <div className={styles.line}></div>
            <Link to="/explore/adaptation-movies" className={styles.link}>
              Adaptation Movies
            </Link>
            <div className={styles.line}></div>
            <Link to="/explore/classic-movies" className={styles.link}>
              Classic Movies
            </Link>
          </div>
        </div>
        <div>
          ...
          <div className={styles.movies}>
            <Link
              to="/explore/online-streaming-plays-plays"
              className={styles.link}
            >
              Online Streaming Plays Plays
            </Link>
            <div className={styles.line}></div>
            <Link to="/explore/drama-plays" className={styles.link}>
              Drama Plays
            </Link>
            <div className={styles.line}></div>
            <Link to="/explore/fantasy-plays" className={styles.link}>
              Fantasy Plays
            </Link>
            <div className={styles.line}></div>
            <Link to="/explore/mystery-plays" className={styles.link}>
              Mystery Plays
            </Link>
            <div className={styles.line}></div>
            <Link to="/explore/noir-plays" className={styles.link}>
              Noir Plays
            </Link>
            <div className={styles.line}></div>
            <Link to="/explore/political-plays" className={styles.link}>
              Political Plays
            </Link>
            <div className={styles.line}></div>
            <Link to="/explore/tragedy-plays" className={styles.link}>
              Tragedy Plays
            </Link>
            <div className={styles.line}></div>
            <Link to="/explore/suspense-plays" className={styles.link}>
              Suspense Plays
            </Link>
            <div className={styles.line}></div>
            <Link to="/explore/adult-plays" className={styles.link}>
              Adult Plays
            </Link>
            <div className={styles.line}></div>
            <Link to="/explore/biography-plays" className={styles.link}>
              Biography Plays
            </Link>
            <div className={styles.line}></div>
            <Link to="/explore/action-plays" className={styles.link}>
              Action Plays
            </Link>
            <div className={styles.line}></div>
            <Link to="/explore/historical-plays" className={styles.link}>
              Historical Plays
            </Link>
            <div className={styles.line}></div>
            <Link to="/explore/musical-plays" className={styles.link}>
              Musical Plays
            </Link>
            <div className={styles.line}></div>
            <Link to="/explore/psychological-plays" className={styles.link}>
              Psychological Plays
            </Link>
            <div className={styles.line}></div>
            <Link to="/explore/sci-fi-plays" className={styles.link}>
              Sci-Fi Plays
            </Link>
            <div className={styles.line}></div>
            <Link to="/explore/broadway-plays" className={styles.link}>
              Broadway Plays
            </Link>
            <div className={styles.line}></div>
            <Link to="/explore/period-plays" className={styles.link}>
              Period Plays
            </Link>
            <div className={styles.line}></div>
            <Link to="/explore/war-plays" className={styles.link}>
              War Plays
            </Link>
            <div className={styles.line}></div>
            <Link to="/explore/adventure-plays" className={styles.link}>
              Adventure Plays
            </Link>
            <div className={styles.line}></div>
            <Link to="/explore/mythological-plays" className={styles.link}>
              Mythological Plays
            </Link>
            <div className={styles.line}></div>
            <Link to="/explore/regional-plays" className={styles.link}>
              Regional Plays
            </Link>
            <div className={styles.line}></div>
            <Link to="/explore/horror-plays" className={styles.link}>
              Horror Plays
            </Link>
            <div className={styles.line}></div>
            <Link to="/explore/adaptation-plays" className={styles.link}>
              Adaptation Plays
            </Link>
            <div className={styles.line}></div>
            <Link to="/explore/classic-plays" className={styles.link}>
              Classic Plays
            </Link>
            <div className={styles.line}></div>
            <Link to="/explore/tribute-plays" className={styles.link}>
              Tribute Plays
            </Link>
            <div className={styles.line}></div>
            <Link to="/explore/romantic-plays" className={styles.link}>
              Romantic Plays
            </Link>
            <div className={styles.line}></div>
            <Link to="/explore/contemporary-plays" className={styles.link}>
              Contemporary Plays
            </Link>
            <div className={styles.line}></div>
            <Link to="/explore/comedy-plays" className={styles.link}>
              Comedy Plays
            </Link>
            <div className={styles.line}></div>
            <Link to="/explore/thriller-plays" className={styles.link}>
              Thriller Plays
            </Link>
            <div className={styles.line}></div>
          </div>
