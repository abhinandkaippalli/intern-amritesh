    ...
    <div className={styles.ticket}>
      <div className={styles.ticket__top}>
        <div className={styles.ticket__top__image}>
          <img src={banner_image_url} alt={`${movie_name} banner`} />
        </div>
      ...
      <div className={styles.ticket__bottom}>
        ...
        <div className={styles.ticket__bottom__info}>
          <div className={styles.ticket__bottom__info__number}>
            <h1>{silver.length + platinium.length}</h1>
            <p>Tickets</p>
          </div>
          <div>
            {silver.length > 0 && (
          ...
          <div className={styles.ticket__bottom__info__stamp}>
            ...
            <div>
              <BsFillStarFill
                className={styles.ticket__bottom__info__stamp__text}
              />
              <p className={styles.ticket__bottom__info__stamp__text}>
                Tickets
              </p>
              <p className={styles.ticket__bottom__info__stamp__text}>booked</p>
              <BsFillStarFill
                className={styles.ticket__bottom__info__stamp__text}
              />
            </div>
